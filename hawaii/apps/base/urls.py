...
from hawaii.apps.base.views import SearchFormView, SearchQueryView, SearchProductsView, ConfirmProductsView
...
urlpatterns = patterns('',
    ...
    url(r'^confirm/$', ConfirmProductsView.as_view(), name="confirm_view"),
)
